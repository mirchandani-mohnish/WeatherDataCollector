...
//  bmp 180 
    ...
    uvSensorVoltage = ((float)uvVal/1024)*5.0;
    uvIndex = (float)uvSensorVoltage/0.1;
//    Serial.println("Looping");
//    Wire.requestFrom(0x77,4);
//     Serial.println(Wire.available());
//     
//     while (Wire.available()) { // peripheral may send less than requested
//      char c = Wire.read(); // receive a byte as character
//      Serial.print(c);   
//      pressureVal = (int)c;// print the character
//     }
...
//    Serial.beginPacket();
//    Serial.print("Just something");
    Serial.print("00//");
    Serial.print(DHTTemp);
    Serial.print("//");
    Serial.print(DHTHumVal);
    Serial.print("//");
    Serial.print(random() < 0.5 ? (1022) : (1023));
    Serial.print("//");
